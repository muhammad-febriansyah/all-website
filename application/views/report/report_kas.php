...
$sql = "SELECT a.kode_kas, SUBSTRING(a.tanggal, 1, 10) AS tgl, a.jenis, a.nominal, a.keterangan, b.nama_lengkap FROM kas a, user b WHERE a.id_user = b.id_user AND SUBSTRING(a.tanggal, 1, 10) BETWEEN '$awal' AND '$akhir'";
