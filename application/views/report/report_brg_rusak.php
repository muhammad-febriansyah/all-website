...
$pdf->Cell(0,5,'LAPORAN BARANG RUSAK',0,1,'C');	
...
WHERE a.id_satuan = c.id_satuan AND a.id_kategori = b.id_kategori AND d.id_barang = a.id_barang AND d.jenis = 'Barang Rusak' AND SUBSTRING(d.tanggal, 1, 10) BETWEEN '$awal' AND '$akhir'";
$data = $this->db->query($sql)->result_array();
    ...
    $sql_nilai = "SELECT SUM(nilai) AS nilai FROM barang_operasional WHERE jenis = 'Barang Rusak' AND SUBSTRING(tanggal, 1, 10) BETWEEN '$awal' AND '$akhir'";
...
$pdf->Output('laporan_barang_rusak.pdf', 'I');