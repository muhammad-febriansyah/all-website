                  ...
                  <form class="form-horizontal" method="post" action="<?php echo base_url('barcode/index')?>">
                    <div class="form-group">
                      ...
                      <div style="float: right">
                        ...
                        <button type="button" onclick="Generate()" class="btn btn-primary"><i class="fa fa-barcode m-right-xs"></i> Generate</button>
      ...
      <script src="<?php echo base_url('assets/Javascript/mod-barcode.js')?>"></script>
