...
class Customer_m extends CI_Model {
    ...
    public function cekDelete($id){
     ...
     public function getPoin(){
         $sql = "SELECT a.id_cs, a.nama_cs, a.alamat, a.email, a.kode_cs, a.telp, COUNT(b.id_cs) AS total FROM customer a, penjualan b
         WHERE a.id_cs = b.id_cs GROUP BY b.id_cs";
